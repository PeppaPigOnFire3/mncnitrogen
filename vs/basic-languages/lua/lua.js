...
define(["require", "exports"], function (require, exports) {
    ...
    exports.language = {
        defaultToken: '',
        tokenPostfix: '.lua',
        keywords: 'and break continue do else elseif end for function if in local not or repeat return then until while next Nitrogen Oxygen Fluxus KiwiX Vega JJSploit WRD Nihon Krnl LInjector Synapse ScriptWare Electron Comet Shadow Dansploit Rune AstridX Hydrogen Rubisco TaaprWare'.split(' '),
